...
func (r *redeemRejectRepo) ListWithFilters(ctx context.Context, params pagination.PaginationParams, codeType, status, search, category string) ([]RedeemCode, *pagination.PaginationResult, error) {
