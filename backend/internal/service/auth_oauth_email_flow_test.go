...
func (s *redeemCodeRepoStub) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, string) ([]RedeemCode, *pagination.PaginationResult, error) {
