...
import (
	...
	"github.com/jksn12/JKAPI/ent/paymentorder"
	"github.com/jksn12/JKAPI/internal/payment"
	"github.com/jksn12/JKAPI/internal/payment/provider"
...
func (s *PaymentService) buildPaymentSubject(plan *dbent.SubscriptionPlan, limitAmount float64, cfg *PaymentConfig, sel *payment.InstanceSelection) string {
	if plan != nil {
		...
		if productName == "" {
			productName = "JKAPI Subscription " + plan.Name
		}
	...
	return "JKAPI " + amountStr + " " + currency
}
