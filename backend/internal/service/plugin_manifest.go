...
type PluginRequirements struct {
	JKAPI                   string   `json:"sub2api"`
	RecommendedJKAPIVersion string   `json:"recommended_sub2api_version,omitempty"`
	TestedJKAPIVersions     []string `json:"tested_sub2api_versions,omitempty"`
...
type PluginCompatibility struct {
	...
	CurrentJKAPI     string `json:"current_sub2api_version"`
	RequiredJKAPI    string `json:"required_sub2api_version"`
	RecommendedJKAPI string `json:"recommended_sub2api_version"`
	PluginProtocol   int    `json:"plugin_protocol"`
	TransportAPI     int    `json:"transport_api"`
	UIBridge         int    `json:"ui_bridge"`
}
...
func (m PluginManifest) Validate() error {
	...
	if strings.TrimSpace(m.Requires.JKAPI) == "" {
