...
func TestEmailQueueTasksPreserveLocaleHints(t *testing.T) {
	...
	require.NoError(t, queue.EnqueueVerifyCode("user@example.com", "JKAPI", "zh-CN"))
	require.NoError(t, queue.EnqueuePasswordReset("user@example.com", "JKAPI", "https://example.com/reset", "en-US"))
