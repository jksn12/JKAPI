...
const (
	...
	configuredCodexCustomDescription   = "Custom model routed through JKAPI."
...
func newConfiguredCodexModelDescriptor(modelID string) configuredCodexModelDescriptor {
	...
	if isDeepSeekCodexModel(modelID) {
		...
		descriptor.Description = "DeepSeek coding and reasoning model routed through JKAPI."
	...
	if isGrokCodexModel(modelID) {
		...
		descriptor.Description = "Grok coding and reasoning model routed through JKAPI."
		descriptor.SupportsParallelToolCalls = true
	...
	if isClaudeCodexModel(modelID) {
		...
		descriptor.Description = "Claude coding and reasoning model routed through JKAPI."
		descriptor.SupportsParallelToolCalls = true
	...
	if isOpenAICodexGPTModel(modelID) {
		...
		descriptor.Description = "OpenAI GPT coding model routed through JKAPI."
		descriptor.SupportsParallelToolCalls = true
