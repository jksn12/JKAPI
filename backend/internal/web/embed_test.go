...
func TestInjectSiteTitle(t *testing.T) {
	t.Run("replaces_title_with_site_name", func(t *testing.T) {
		html := []byte(`<html><head><title>JKAPI - AI API Gateway</title></head><body></body></html>`)
		...
		assert.NotContains(t, string(result), "JKAPI")
	})
	...
	t.Run("returns_unchanged_when_title_has_attributes", func(t *testing.T) {
		...
		html := []byte(`<html><head><title lang="en">JKAPI</title></head><body></body></html>`)
	...
	t.Run("escapes_ampersand_in_site_name", func(t *testing.T) {
		html := []byte(`<html><head><title>JKAPI</title></head><body></body></html>`)
	...
	t.Run("preserves_rest_of_html", func(t *testing.T) {
		html := []byte(`<html><head><meta charset="UTF-8"><title>JKAPI</title><script src="app.js"></script></head><body><div id="app"></div></body></html>`)
