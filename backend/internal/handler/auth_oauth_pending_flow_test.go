...
import (
	...
	"github.com/jksn12/JKAPI/ent/identityadoptiondecision"
	"github.com/jksn12/JKAPI/ent/pendingauthsession"
	"github.com/jksn12/JKAPI/ent/redeemcode"
	dbuser "github.com/jksn12/JKAPI/ent/user"
...
func (r *oauthPendingFlowRedeemCodeRepo) ListWithFilters(context.Context, pagination.PaginationParams, string, string, string, string, string) ([]service.RedeemCode, *pagination.PaginationResult, error) {
	panic("unexpected ListWithFilters call")
}
