...
JKAPI is an AI API Gateway Platform for distributing and managing AI product subscription API quotas.
...
docker run -d \
  --name jkapi \
  -p 8080:8080 \
  -e DATABASE_URL="postgres://user:pass@host:5432/jkapi" \
  -e REDIS_URL="redis://host:6379" \
  weishaw/jkapi:latest
```
...
services:
  jkapi:
    image: weishaw/jkapi:latest
    ports:
      - "8080:8080"
    environment:
      - DATABASE_URL=postgres://postgres:postgres@db:5432/jkapi?sslmode=disable
...
- [GitHub Repository](https://github.com/weishaw/jkapi)
- [Documentation](https://github.com/weishaw/jkapi#readme)
