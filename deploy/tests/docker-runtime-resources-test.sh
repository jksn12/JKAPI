...
assert_line Dockerfile.goreleaser 'COPY --chown=jkapi:jkapi backend/resources /app/resources'
assert_line deploy/Dockerfile 'COPY --from=backend-builder --chown=jkapi:jkapi /app/backend/resources /app/resources'
