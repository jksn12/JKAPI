...
function create() {
  const item = { id: makeId('canvas'), title: `画布 ${items.value.length + 1}`, nodes: 0, edges: 0, updatedAt: new Date().toISOString() }
